...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.shagCB.setItemText(4, _translate("MainWindow", "0.7"))
        self.shagCB.setItemText(5, _translate("MainWindow", "0.75"))
        self.shagCB.setItemText(6, _translate("MainWindow", "0.8"))
        self.shagCB.setItemText(7, _translate("MainWindow", "1"))
        self.shagCB.setItemText(8, _translate("MainWindow", "1.25"))
        self.shagCB.setItemText(9, _translate("MainWindow", "1.5"))
        self.shagCB.setItemText(10, _translate("MainWindow", "2.5"))
        self.shagCB.setItemText(11, _translate("MainWindow", "3"))
        self.shagCB.setItemText(12, _translate("MainWindow", "3.5"))
